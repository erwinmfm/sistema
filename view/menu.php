        ...
        <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="inicio.php"><img class="img-fluid img-thumbnail" src="../img/phpoo.png" alt="" width="100px"></a>
                    <!-- <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/logo_topvape.png" alt="" width="100px" height="100px"></a> -->
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                ?>
                                        ...
                                        <li>
                                            <a href="usuarios.php"><span class="glyphicon glyphicon-pencil"></span> Gestão Usuários</a>
                                        </li>
